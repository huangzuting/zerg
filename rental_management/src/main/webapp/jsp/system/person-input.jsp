		...
		$("#inputForm").submit(
				function() {
					...
					if (flag) {
						...
						$.post("${ctx}/card/card-person-input.do", json,
								function(data) {
									if (data.status) {
					...
					<tbody>
						...
						<tr id="title_T2">
							...
							<td colspan="2" class="td_02"><input type="text" id="name"
								...
								data-options="required:true,width:'120'" value=""
						...
						<tr id="title_T10" style="margin-top: 10px;">
							<td align="right" class="td_01">设备地址：</td>
							<input type="hidden" value="${devid }"  id="devid" name="devid">
							
							<td colspan="4"><input type="text" id="address" size="30"
								maxlength="50" class="easyui-textbox"
								data-options="required:true,width:'400px'" value="${houseId}"
						...
						<tr id="title_T11" style="margin-top: 10px;">
							...
							<td colspan="2"><input class="easyui-textbox textbox-f"
								...
								data-options="required:true,width:'300px'" value=""
